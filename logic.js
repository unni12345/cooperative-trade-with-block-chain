 ...
 * @transaction
 */
function loanRequest(tx) {
    if tx.totalAmount >= 50000 && tx.loanstatus!=1 {
        tx.inVoice.rate=tx.rate
        tx.inVoice.timePeriod=tx.inVoice.timePeriod
        tx.inVoice.loanstatus=1
    }
...
describe('#'+NS, function() {
    ...
    before(function() {
        ...
        .then(function() {
            ...
            return businessNetworkConnection.connect('defaultProfile', 'tutorial-network', 'admin', 'Xurw3yU9zI0l');
        });
    });
    ...
    describe('ChangeAssetValue()', function() {
        ...
        it('should change the value property of ' + assetType + ' to newValue', () => {
            ...
            // create a user
            var user = factory.newResource(NS, 'User', 'Raj Krishnan V');
